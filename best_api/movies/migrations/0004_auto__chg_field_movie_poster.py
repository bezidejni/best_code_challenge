...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'movies_movie', 'poster', self.gf('django.db.models.fields.files.ImageField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Movie.poster'
        db.alter_column(u'movies_movie', 'poster', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
